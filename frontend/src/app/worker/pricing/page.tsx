...
const PLANS: PlanTier[] = [
  {
    ...
    features: [
      ...
      '15-trigger parametric coverage (rain, AQI, heat, closures)',
      'Pre-agreed payout bands — no claim negotiation',
      'Automated fraud screening (5-layer Ghost Shift Detector)',
      'Standard claim processing (24-48h review)',
      'Weekly auto-renewal with opt-out',
    ],
    target: 'Core cover · affordable · every worker should have this',
    color: 'blue',
  ...
  },
  {
    ...
    features: [
      ...
      '15-trigger coverage + T15 composite disruption events',
      'Pre-agreed payout bands — no claim negotiation',
      'Advanced Ghost Shift Detector + evidence forensics',
      'Gemini AI claim narrative reports for faster resolution',
      'Priority review queue (under 12h processing)',
      'Proportional multi-day payout for extended disruptions',
      'Regional cluster fast-lane auto-compensation',
    ],
    target: 'Higher ceiling · faster processing · experienced workers',
    color: 'emerald',
