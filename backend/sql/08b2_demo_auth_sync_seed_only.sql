-- ==========================================================================
-- 08b2_demo_auth_sync_seed_only.sql
-- Covara One - Demo Auth Sync/Seed Only (timeout-safe chunk)
-- ==========================================================================
-- Purpose:
--   Sync profile roles/extensions and seed realistic demo worker persona
...
begin
  ...
  if v_worker_id is not null then
    ...
    values (
      ...
      28,
      1500,
      jsonb_build_object('seed', '08b2_demo_auth_sync_seed_only', 'scenario', 'auto_approved'),
      now()
    )
    on conflict (id) do update
