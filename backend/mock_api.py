...
TRIGGER_LIBRARY = [
    ...
    {
        "id": "T2",
        "name": "Heavy Rain Claim",
        "threshold": "24h rain >= 64.5 mm",
        "tier": "Claim Trigger",
        "anchoring": "public",
        "source": "IMD",
    },
    {
        "id": "T3",
        "name": "Extreme Rain Escalation",
        "threshold": "24h rain >= 115.6 mm",
        "tier": "Severe Escalation",
        "anchoring": "public",
        "source": "IMD",
    },
    {
        "id": "T4",
        "name": "Waterlogging Mobility",
        "threshold": "accessibility_score <= 0.40",
        "tier": "Claim Trigger",
        "anchoring": "operational",
    },
    {
        "id": "T5",
        "name": "AQI Caution",
        "threshold": "AQI 201-300",
        "tier": "Early Warning",
        "anchoring": "public",
        "source": "CPCB",
    },
    {
        "id": "T6",
        "name": "AQI Severe Exposure",
        "threshold": "AQI >= 301 + active shift",
        "tier": "Claim Trigger",
        "anchoring": "public",
        "source": "CPCB",
    },
    {
        "id": "T7",
        "name": "Heat Wave",
        "threshold": "temp >= 45C or IMD heat-wave",
        "tier": "Claim Trigger",
        "anchoring": "public",
        "source": "IMD/NDMA",
    },
    ...
    {
        "id": "T9",
        "name": "Heat Persistence",
        "threshold": "2 consecutive hot-risk days",
        "tier": "Early Warning",
        "anchoring": "public",
        "source": "IMD/NDMA",
    },
    {
        "id": "T10",
        "name": "Local Zone Closure",
        "threshold": "closure_flag = 1",
        "tier": "Claim Trigger",
        "anchoring": "operational",
    },
    {
        "id": "T11",
        "name": "Curfew / Strike Closure",
        "threshold": "restriction >= 4h",
        "tier": "Claim Trigger",
        "anchoring": "operational",
    },
    {
    ...
    },
    {
        ...
        "threshold": "orders drop >= 35% vs baseline",
        "tier": "Early Warning",
        "anchoring": "operational",
    },
    {
        "id": "T15",
        "name": "Composite Disruption",
        "threshold": "composite score >= 0.70",
        "tier": "Severe Escalation",
        "anchoring": "operational",
    },
]
