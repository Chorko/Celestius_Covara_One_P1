...
def _make_trigger_events(zone_lookup: dict[str, str]) -> list[dict]:
    ...
    events = [
        ...
        {
            "city": "Mumbai",
            "zone_id": zone_lookup["Mumbai-Andheri-W"],
            "trigger_family": "rain",
        ...
        {
            "city": "Mumbai",
            "zone_id": zone_lookup["Mumbai-Bandra-Kurla"],
            "trigger_family": "rain",
        ...
        {
            "city": "Delhi",
            "zone_id": zone_lookup["Delhi-Connaught-Place"],
            "trigger_family": "aqi",
            "trigger_code": "AQI_SEVERE",
            "source_ref_id": "R1",
        ...
        {
            "city": "Delhi",
            "zone_id": zone_lookup["Delhi-Saket-South"],
            "trigger_family": "heat",
            "trigger_code": "HEAT_WAVE",
            "source_ref_id": "R4",
            "observed_value": 46.0,
        ...
        {
            "city": "Bangalore",
            "zone_id": zone_lookup["Bangalore-Koramangala"],
            "trigger_family": "traffic",
            "trigger_code": "TRAFFIC_SEVERE",
            "source_ref_id": None,
            "observed_value": 55.0,
            "official_threshold_label": None,
            "product_threshold_value": "40%+ delay",
            "severity_band": "watch",
            "source_type": "internal_operational",
        ...
        {
            "city": "Bangalore",
            "zone_id": zone_lookup["Bangalore-Indiranagar"],
            "trigger_family": "outage",
            "trigger_code": "PLATFORM_OUTAGE",
            "source_ref_id": None,
            "observed_value": 45.0,
            "official_threshold_label": None,
        ...
        {
            "city": "Hyderabad",
            "zone_id": zone_lookup["Hyderabad-Madhapur"],
            "trigger_family": "demand",
            "trigger_code": "DEMAND_COLLAPSE",
            "source_ref_id": None,
            "observed_value": 42.0,
            "official_threshold_label": None,
        ...
        {
            "city": "Hyderabad",
            "zone_id": zone_lookup["Hyderabad-Gachibowli"],
            "trigger_family": "aqi",
            "trigger_code": "AQI_EXTREME",
            "source_ref_id": "R1",
        ...
        stats.append(
            {
                ...
                "platform_login_minutes": int(
                    active_h * 60 + random.randint(-30, 30)
                ),
    ...
    try:
        ...
        if a_exist.data:
            ...
            sb.table("insurer_profiles").insert(
                {
                    "profile_id": a_id,
                    "company_name": "DEVTrails Insurance",
