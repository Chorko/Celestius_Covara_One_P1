...
def calculate_policy_metrics(worker_context: dict) -> dict:
    ...
    # The documentation references 6 days statically, but we'll use
    # active_days for dynamic accuracy
...
def calculate_payout(
    ...
    # FH is derived from fraud_penalty, e.g. FH = fraud_penalty * 0.5 for
    # holdback
