...
TRIGGER_LIBRARY = {
    ...
    "COMPOSITE": {
        ...
        "family": "composite",
        "band": "escalation",
        "threshold": ">= 0.70 score",
        "source": "internal",
    },
    # Added based on threshold table
    "AQI_EXTREME": {
        "id": "T16",
        "family": "aqi",
        "band": "escalation",
...
def get_overlapping_triggers(
    sb, zone_id: str, shift_start: str, shift_end: str
) -> list[dict]:
    ...
    # but we can fetch events that started before shift ends, and filter out
    # those that ended before shift starts.
