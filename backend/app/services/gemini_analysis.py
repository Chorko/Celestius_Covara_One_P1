...
async def generate_claim_narrative(claim_record: dict, pipeline_result: dict, worker_context: dict) -> str:
    """
    ...
    if not settings.gemini_api_key:
        return "AI analysis unavailable: GEMINI_API_KEY not configured on server."
    ...
    try:
        ...
        payout_rec = pipeline_result.get('payout_recommendation', {})
